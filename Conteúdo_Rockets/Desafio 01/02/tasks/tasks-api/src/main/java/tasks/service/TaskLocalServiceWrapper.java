...
public class TaskLocalServiceWrapper
	 ...
	 */
	@Override
	public tasks.model.Task addTask(tasks.model.Task task) {
	 ...
	 */
	@Override
	public tasks.model.Task createTask(long taskId) {
	 ...
	 */
	@Override
	public tasks.model.Task deleteTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public tasks.model.Task deleteTask(tasks.model.Task task) {
	...
	@Override
	public tasks.model.Task fetchTask(long taskId) {
	 ...
	 */
	@Override
	public tasks.model.Task getTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<tasks.model.Task> getTasks(int start, int end) {
	 ...
	 */
	@Override
	public tasks.model.Task updateTask(tasks.model.Task task) {
