...
import tasks.model.TaskModel;

/**
 * The base model implementation for the Task service. Represents a row in the &quot;tasks_Task&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TaskModelImpl extends BaseModelImpl<Task> implements TaskModel {
	 ...
	 */
	public static final String TABLE_NAME = "tasks_Task";
	...
	public static final String TABLE_SQL_CREATE =
		"create table tasks_Task (taskId LONG not null primary key,title VARCHAR(75) null,description VARCHAR(75) null,completed BOOLEAN,createDate DATE null)";

	public static final String TABLE_SQL_DROP = "drop table tasks_Task";

	public static final String ORDER_BY_JPQL = " ORDER BY task.taskId ASC";

	public static final String ORDER_BY_SQL = " ORDER BY tasks_Task.taskId ASC";
