...
import tasks.exception.NoSuchTaskException;
...
import tasks.service.persistence.TaskPersistence;
import tasks.service.persistence.TaskUtil;
import tasks.service.persistence.impl.constants.tasksPersistenceConstants;
...
public class TaskPersistenceImpl
	...
	@Override
	@Reference(
		target = tasksPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = tasksPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
